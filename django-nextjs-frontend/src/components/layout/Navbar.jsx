...
export default function Navbar({className}) {
    ...
    <div className="flex w-full items-center gap-4 md:ml-auto md:gap-2 lg:gap-4">
      ...
      <form onSubmit={e => { e.preventDefault(); if (search.trim()) router.push(`/products?search=${encodeURIComponent(search)}`); }} className="hidden md:flex items-center gap-3 ml-auto mr-10">
        <input
          type="text"
